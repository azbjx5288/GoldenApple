...
import com.goldenapple.lottery.component.AdvertisementView;
import com.goldenapple.lottery.component.AppBarLayoutOverScrollViewBehavior;
import com.goldenapple.lottery.component.CommonTabLayout;
import com.goldenapple.lottery.component.CustomTabEntity;
import com.goldenapple.lottery.component.CycleViewPager;
import com.goldenapple.lottery.component.FragImageView;
import com.goldenapple.lottery.component.HomeFragmentPagerAdapter;
import com.goldenapple.lottery.component.OnSortClickListener;
import com.goldenapple.lottery.component.OnTabSelectListener;
import com.goldenapple.lottery.component.RoundProgressBar;
import com.goldenapple.lottery.component.ViewFactory;
import com.goldenapple.lottery.data.ActivityCommand;
import com.goldenapple.lottery.data.ActivityData;
import com.goldenapple.lottery.data.BannerListCommand;
import com.goldenapple.lottery.data.Lottery;
import com.goldenapple.lottery.data.LotteryListCommand;
import com.goldenapple.lottery.data.Notice;
import com.goldenapple.lottery.data.Series;
import com.goldenapple.lottery.data.SeriesCommand;
import com.goldenapple.lottery.material.ConstantInformation;
import com.goldenapple.lottery.material.RecordType;
import com.goldenapple.lottery.pattern.TabEntity;
...
public class FragmentHome extends LazyBaseFragment {
    ...
    private void initListener() {
        ...
        mTagContainerLayout.setOnTagClickListener(new TagView.OnTagClickListener() {
            ...
            public void onTagClick(int position, String text) {
                if (site == 0) {
                    List<Series> seriess = GoldenAppleApp.getUserCentre().getSeriesList();
                    if (seriess.size() > 0) {
                        if (position != 0) {
    ...
    private void activityLoad() {
        ...
        command.setUserdId(GoldenAppleApp.getUserCentre().getUserInfo().getId());
        command.setToken(GoldenAppleApp.getUserCentre().getUserInfo().getToken());
        ...
        public boolean onRestComplete(RestRequest request, RestResponse response) {
            switch (request.getId()) {
                ...
                case SERIES_ID: //获取彩种信息
                    ...
                    if (series.size() > 0) {
                        GoldenAppleApp.getUserCentre().setSeriesList(series);
