...
import com.goldenapple.lottery.data.GetThirdGabbyCommand;
import com.goldenapple.lottery.data.GetThirdGabbyUrl;
...
public class GameAgFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflateView(inflater, container, "AG游戏", R.layout.fragment_game_ga, false, false);
    }
