...
import com.goldenapple.lottery.data.BetDetailCommand;
import com.goldenapple.lottery.data.CancelPackageCommand;
import com.goldenapple.lottery.data.CancelTraceCommand;
import com.goldenapple.lottery.data.Lottery;
import com.goldenapple.lottery.data.Trace;
import com.goldenapple.lottery.data.TraceDetailCommand;
    ...
    private class JsInterface {
        ...
        public void changeUi(final int lotteryId, final boolean supportCancel, final String[] pkids) {
            ...
            button.post(new Runnable() {
                @Override
                public void run() {
                    lottery = GoldenAppleApp.getUserCentre().getLottery(lotteryId);
                    if (lottery == null) {
