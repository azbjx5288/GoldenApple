...
import com.goldenapple.lottery.data.BackToken;
import com.goldenapple.lottery.data.BindCardDetail;
import com.goldenapple.lottery.data.CardDetailCommand;
import com.goldenapple.lottery.data.ReviseCommand;
import com.goldenapple.lottery.data.UserInfo;
import com.goldenapple.lottery.data.UserInfoCommand;
import com.goldenapple.lottery.data.WithdrawCommand;
...
public class DrawFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        money.setText(String.format("%.4f", GoldenAppleApp.getUserCentre().getUserInfo().getWithdrawable()));
        loadInfo();
