...
import com.goldenapple.lottery.material.SaveImageUtils;
import com.goldenapple.lottery.util.DownPicUtil;
...
//        initImmersionBarEnabled();
    ...
    void callCard(String path) {
        saveImageInto(GoldenAppleApp.getInstance().getBaseUrl() + path);
    }
