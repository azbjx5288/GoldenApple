...
import com.goldenapple.lottery.view.adapter.TabsAdapter;

public class ScrollingTabsView extends HorizontalScrollView implements OnPageChangeListener {

    @SuppressWarnings("unused")
    private static final String TAG = ScrollingTabsView.class.getSimpleName();
     ...
     *
     * @param adapter The {@link TabsAdapter} which is responsible for maintaining the
