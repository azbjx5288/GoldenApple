    ...
    public static class Builder {
        ...
        private View setLeftAndRightLevel(View layout, final CustomDialog dialog) {
            ...
            if (positiveButtonText != null) {
                ...
                positiveButton.setBackgroundResource(R.drawable.notidialog_rightbtn_half_selector);
                if (positiveButtonClickListener != null) {
                    positiveButton.setOnClickListener((View v) -> {
                        positiveButtonClickListener.onClick(dialog, DialogInterface.BUTTON_POSITIVE);
                    });
            ...
            if (negativeButtonText != null) {
                ...
                negativeButton.setBackgroundResource(R.drawable.notidialog_leftbtn_half_selector);
                if (negativeButtonClickListener != null) {
                    negativeButton.setOnClickListener((View v) -> {
                        negativeButtonClickListener.onClick(dialog, DialogInterface.BUTTON_NEGATIVE);
                    });
