...
public class Kl8CommonGame extends Game
{
    ...
    //任选一
    public static void fs400Random(Game game) {singleRandom(game, 1);}
    
    //任选二
    public static void fs401Random(Game game) {singleRandom(game, 2);}
    
    //任选三
    public static void fs402Random(Game game) {singleRandom(game, 3);}
    
    //任选四
    public static void fs403Random(Game game) {singleRandom(game, 4);}
    
    //任选五
    public static void fs404Random(Game game) {singleRandom(game, 5);}
    
    //任选六
    public static void fs405Random(Game game) {singleRandom(game, 6);}
    
    //任选七
    public static void fs406Random(Game game) {singleRandom(game, 7);}
}
