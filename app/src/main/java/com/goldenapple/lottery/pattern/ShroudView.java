    ...
    public ShroudView(View view) {
        ...
        doubleText.setOnQuantityChangeListener(new OnQuantityChangeListener() {
            ...
            public void onQuantityChanged(int newQuantity, boolean programmatically) {
                modeItemListener.onModeItemClick(newQuantity, chaseAddText.getQuantity(), setLucreMode(GoldenAppleApp.getUserCentre().getLucreMode()), appendSettings.isChecked());
            }
        ...
        appendSettings.setOnCheckedChangeListener((arg0, arg1) -> {
            modeItemListener.onModeItemClick(doubleText.getQuantity(), chaseAddText.getQuantity(), setLucreMode(GoldenAppleApp.getUserCentre().getLucreMode()), arg1);
        });
        ...
        discreteSeekBar1.setNumericTransformer(new DiscreteSeekBar.NumericTransformer() {
            ...
            public int transform(int value) {
                ...
                if (modeItemListener != null)
                    modeItemListener.onModeItemClick(doubleText.getQuantity(), chaseAddText.getQuantity(), setLucreMode(GoldenAppleApp.getUserCentre().getLucreMode()), appendSettings.isChecked());
                return value;
            }
        });
