...
import com.goldenapple.lottery.data.City;
import com.goldenapple.lottery.data.County;
import com.goldenapple.lottery.data.Province;
...
public class AddressPicker extends LinkagePicker {
    private static final String TAG = AddressPicker.class.getSimpleName();
    ...
    protected View makeCenterView() {
        ...
        provinceView.setOnWheelViewListener((boolean isUserScroll, int selectedIndex, String item) -> {
        ...
        cityView.setOnWheelViewListener((boolean isUserScroll, int selectedIndex, String item) -> {
        ...
        countyView.setOnWheelViewListener((boolean isUserScroll, int selectedIndex, String item) -> {
