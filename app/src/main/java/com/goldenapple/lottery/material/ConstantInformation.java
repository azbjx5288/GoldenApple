...
public class ConstantInformation {
    ...
    private static Lottery lotteryEmblem;
    ...
    static {
        ...
        //苹果三分彩
        sLotteryLogo.put("PG3FC", new int[]{R.drawable.pg3fc, R.drawable.pg3fc});
        //苹果极速3D
        ...
        //苹果11选5
        sLotteryLogo.put("PG115", new int[]{R.drawable.pg115, R.drawable.pg115});
        //福建11选5
        ...
        //苹果极速PK10
        sLotteryLogo.put("PGPK10", new int[]{R.drawable.pgpk10, R.drawable.pgpk10});
        // 3D
        ...
        // 苹果11选5三分彩
        sLotteryLogo.put("PG115SFC", new int[]{R.drawable.pg11x5sfc, R.drawable.pg11x5sfc});
        //苹果快三分分彩
        sLotteryLogo.put("PGK3", new int[]{R.drawable.pgksffc, R.drawable.pgksffc});
        //广西快三
        ...
        //二八杠
        sLotteryLogo.put("ebg", new int[]{R.drawable.ebg, R.drawable.ebg});
        //四大美女
        sLotteryLogo.put("bcbm", new int[]{R.drawable.sdmn, R.drawable.sdmn});
        //足球世界杯
        sLotteryLogo.put("zqsjb", new int[]{R.drawable.zqsjb, R.drawable.zqsjb});
    ...
    public static String gatherInfo(Activity activity, PayMoneyCommand command) {
        ...
        return "手机IMEI号：" + imei + ",\n手机IESI号：" + iesi + ",\n手机型号：" + android.os.Build.MODEL +
                ...
                .VERSION_CODE + ",\nUserID：" + GoldenAppleApp.getUserCentre().getUserID() + "," +
