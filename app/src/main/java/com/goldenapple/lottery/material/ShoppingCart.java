...
public class ShoppingCart {
    ...
    private LucreMode lucreMode = LucreMode.fromCode(GoldenAppleApp.getUserCentre().getLucreMode()); /** 当前金额模式 */
    private int planNotes = 0;  /** 计划注数 */
    ...
    private int prizeGroup = GoldenAppleApp.getUserCentre().getPrizeGroup();    /** 奖金组 **/
