...
public class GameStickResultAdapter extends BaseAdapter {
    ...
    public GameStickResultAdapter(Lottery lottery, Context context) {
    ...
    public void setData(ArrayList<LotteryCode> resultList, Method methodRecord) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.stick_coderesult_layout_item, parent, false);
        ...
        if (lottery.getSeriesId() == 4) { //快三
            ...
            if (methodRecord != null) {
                if (methodRecord.getId() == 178) {
                    addDragonTiger(holder, list, parent.getContext());
                } else {
