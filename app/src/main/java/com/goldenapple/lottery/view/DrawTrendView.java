package com.goldenapple.lottery.view;
...
public class DrawTrendView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedLink&&!(morelinkData != null && morelinkData.length > 0)) {
    ...
    private void drawTopNum(Canvas canvas) {
        ...
        for (int i = 0, count = maxcopiesx - mincopiesx + 1; i < count; i++) {
            ...
            if (numberStyle == null) {
                ...
                text = String.format(numberStyle ? "%d" : "%02d", i + mincopiesx);
            }
    ...
    private void drawBall(Canvas canvas) {
        ...
        if (solelinkData != null && solelinkData.length > 0) {
            single(canvas);
        } else if (morelinkData != null && morelinkData.length > 0) {
            more(canvas);
        }
    }
    ...
    private void single(Canvas canvas) {
        ...
        for (int i = 0; i < solelinkData.length; i++) {
            ...
            if (numberStyle == null) {
                ...
                text = String.format(numberStyle ? "%d" : "%02d", value);
            }
            canvas.drawText(text, textX, textY, linePaint);
        }
    }
        ...
        for (int i = 0; i < morelinkData.length; i++) {
            ...
            for (int j = 0; j < testRow.length; j++) {
                ...
                if (numberStyle == null) {
                    ...
                    text = String.format(numberStyle ? "%d" : "%02d", xIndex);
                }
                canvas.drawText(text, textX, textY, linePaint);
            }
        }
