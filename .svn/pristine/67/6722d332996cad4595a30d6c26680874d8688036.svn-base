 ...
 *
 * @author ACE
 * @功能描述: Banner 实现可循环，可轮播的viewpager
 */
public class CycleViewPager extends Fragment implements OnPageChangeListener, View.OnTouchListener {
    ...
    private CycleViewPagerHandler.UnleakHandler handler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.cycleviewpager_viewpager_fragment, null);
        ...
        handler = new CycleViewPagerHandler.UnleakHandler(getActivity()) {
     ...
     */
    public void setData(List<View> views, ImageCycleViewListener listener) {
        setData(views, 0, listener);
    }
     ...
     */
    public void setData(List<View> views, int showPosition, ImageCycleViewListener listener) {
        ...
        for (int i = 0; i < indicators.length; i++) {
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.cycleviewpager_indicator, null);
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mImageCycleViewListener != null)
                        mImageCycleViewListener.onImageClick(currentPosition - 1, v);
                }
            });
            container.addView(v);
            return v;
