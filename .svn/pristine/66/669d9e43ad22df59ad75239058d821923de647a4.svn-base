...
public class TagCloudView extends ViewGroup {
    ...
    private static final int SELCECT_TEXT_COLOR = R.color.white;//选中后的标签颜色
    ...
    public TagCloudView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSeclectTagColor = a.getColor(R.styleable.TagCloudView_tcvSeclecTextColor, getResources().getColor(SELCECT_TEXT_COLOR));
    ...
    /**修改某些位置定点颜色**/
    public void setTagsByPosition(HashMap<Integer, Object[]> positions, List<String> tagList){
        this.tags = tagList;
        this.removeAllViews();
