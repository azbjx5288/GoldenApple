...
/**
 * Created by ACE-PC on 2016/7/13.
 * 自定义的radiogroup流式布局
 **/
public class FlowRadioGroup extends ViewGroup implements OnClickListener {
    ...
    public FlowRadioGroup(Context context, AttributeSet attrs,
        ...
        childMarginHorizontal = arr.getDimensionPixelSize(
                R.styleable.FlowRadioGroup_child_margin_horizontal, 15);
        childMarginVertical = arr.getDimensionPixelSize(
                R.styleable.FlowRadioGroup_child_margin_vertical, 5);
        childResId = arr.getResourceId(
                R.styleable.FlowRadioGroup_child_layout, 0);
        childCount = arr.getInt(R.styleable.FlowRadioGroup_child_count, 0);
        singleChoice = arr.getBoolean(
                R.styleable.FlowRadioGroup_single_choice, true);
        childValuesId = arr.getResourceId(
                R.styleable.FlowRadioGroup_child_values, 0);
        gravity = arr.getInt(R.styleable.FlowRadioGroup_gravity, LEFT);
        if (childResId == 0) {
    ...
    public interface OnCheckedChangedListener {
        public void onItemChecked(FlowRadioGroup group, int position,
                                  boolean checked);
    }
}