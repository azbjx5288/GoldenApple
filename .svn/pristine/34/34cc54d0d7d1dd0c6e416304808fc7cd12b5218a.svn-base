...
import com.goldenapple.lottery.app.MainActivity;
import com.goldenapple.lottery.util.SharedPreferencesUtils;
import com.goldenapple.lottery.view.adapter.GuideViewPagerAdapter;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Ace.Dong on 2018/1/4.
 */
public class WelcomeGuideActivity extends Activity implements View.OnClickListener {
    ...
    protected void onPause() {
        ...
        SharedPreferencesUtils.putBoolean(WelcomeGuideActivity.this, SharedPreferencesUtils.FIRST_OPEN, false);
        finish();
    }
