...
import com.goldenapple.lottery.fragment.LoadingDialog;
...
public class VolleyRequest {
    ...
    public static void requestPost(String url, String tag, final Map<String, String> params, VolleyInterface vif) {
        GoldenAppleApp.getHttpQueue().cancelAll(tag);
        ...
        GoldenAppleApp.getHttpQueue().add(stringRequest);
        GoldenAppleApp.getHttpQueue().start();
    }
}
