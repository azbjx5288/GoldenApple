...
import com.goldenapple.lottery.view.adapter.InBoxAdapter;
...
public class MessageInFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.message_in_fragment, container, false);
    }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (mStateIsEdit) {
                    ...
                    BoxDetailsFragment.launch(MessageInFragment.this, String.valueOf(bean.getId()), "receive");
                }
